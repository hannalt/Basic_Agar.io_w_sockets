...
//Figure out a way to make them same bounds on the board for each blob. Maybe color it somehow.
//Win and lose conditions
//If someone disconnects make them disappear or just make them an easy target.
...
function setup() {
    ...
    socket.on('eaten',
        function() {
            rect(blob.pos.x, blob.pos.y, 200, 100)
            
            fill(blob.red, blob.green, blob.blue);
            textAlign(CENTER);
            textSize(12);
            text("You Lose", blobs[i].x, blobs[i].y);
